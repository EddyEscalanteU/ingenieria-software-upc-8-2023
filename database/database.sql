...
--/////////////////////////Tabla de asignacion de ADMINISTRACION PRIVILEGIOS///////////////////////////////////////////
 
CREATE TABLE ADMINISTRACION_PRIVILEGIOS
(
  "ID" INT IDENTITY(1, 1) PRIMARY KEY,
  "ID_ROL" INT NOT NULL,
  "ID_FUNCIONALIDAD" INT NOT NULL,
  CONSTRAINT ROL_FUNCIONALIDAD_UNIQUE UNIQUE ("ID_ROL", "ID_FUNCIONALIDAD"),
  FOREIGN KEY ("ID_ROL") REFERENCES ROLES_USUARIO("ID"),
  FOREIGN KEY ("ID_FUNCIONALIDAD") REFERENCES GESTION_FUNCIONALIDADES("ID")
);
/*
...
select * from ADMINISTRACION_PRIVILEGIOS
...
////ADMINISTRACION_PRIVILEGIOS//
INSERT INTO ADMINISTRACION_PRIVILEGIOS (ID_ROL, ID_FUNCIONALIDAD, FECHA_ASIGNACION, ESTADO_ASIGNACION)
VALUES (1, 1, '2023-09-19 10:00:00', 1);

INSERT INTO ADMINISTRACION_PRIVILEGIOS (ID_ROL, ID_FUNCIONALIDAD, FECHA_ASIGNACION, ESTADO_ASIGNACION)
VALUES (2, 2, '2023-09-19 11:30:00', 1);

INSERT INTO ADMINISTRACION_PRIVILEGIOS (ID_ROL, ID_FUNCIONALIDAD, FECHA_ASIGNACION, ESTADO_ASIGNACION)
VALUES (3, 3, '2023-09-19 09:15:00', 1);

INSERT INTO ADMINISTRACION_PRIVILEGIOS (ID_ROL, ID_FUNCIONALIDAD, FECHA_ASIGNACION, ESTADO_ASIGNACION)
VALUES (1, 2, '2023-09-20 14:45:00', 1);
